...
# Stage-2 gate: train only the Intent-v2 Last-action baseline after Local vs
# Type-Oracle has demonstrated a consistent total-return gap.
...
command=(
  ...
  --env-config=gymma
  with
  env_args.key=epymarl/Switching-LBF-LastAction-Intent-v2
...
echo "Intent-v2 Last-action training completed."
