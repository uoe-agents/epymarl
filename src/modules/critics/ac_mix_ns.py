...
class IA2CMIXCriticNS(nn.Module):
    def __init__(self, scheme, args):
        super(IA2CMIXCriticNS, self).__init__()
        ...
        self.critics = [MLP(input_shape, args.hidden_dim, self.args.n_actions) for _ in range(self.n_agents)]
